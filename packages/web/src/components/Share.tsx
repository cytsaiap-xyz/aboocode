...
import { IconAboocode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "aboocode/session/message-v2"
import type { Message } from "aboocode/session/message"
import type { Session } from "aboocode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.aboocode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.aboocode_name}>
                    <IconAboocode width={16} height={16} />
                  </div>
