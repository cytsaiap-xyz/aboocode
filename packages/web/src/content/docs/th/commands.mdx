...
สร้าง `.aboocode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Aboocode:
...
- ระดับผู้ใช้ (Global): `~/.config/aboocode/commands/`
- ระดับโปรเจ็กต์: `.aboocode/commands/`
...
Aboocode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
