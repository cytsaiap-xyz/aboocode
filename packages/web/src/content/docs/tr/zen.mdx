---
title: Zen
description: aboocode ekibinin sundugu secili model listesi.
---
...
Aboocode Zen, aboocode ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
Aboocode Zen su anda beta asamasindadir.
:::

Zen, aboocode'daki diger provider'lar gibi calisir. Aboocode Zen'e giris yapar ve API anahtarinizi alirsiniz.
Tamamen istege baglidir; aboocode kullanmak icin Zen kullanmak zorunda degilsiniz.
...
:::tip
aboocode ile iyi calisan belirli model/provider kombinasyonlarini test ettik.
:::
...
Aboocode Zen, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

Aboocode Zen, aboocode'daki diger provider'lar gibi calisir.

1. **<a href={console}>Aboocode Zen</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, Aboocode Zen'i secin ve API anahtarinizi yapistirin
...
aboocode config'inizdeki [model id](/docs/config/#models), `aboocode/<model-id>` formatini kullanir.
Ornegin GPT 5.2 Codex icin config'te `aboocode/gpt-5.2-codex` kullanirsiniz.
...
- GLM 4.7 Free, sinirli bir sure icin aboocode'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Kimi K2.5 Free, sinirli bir sure icin aboocode'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- MiniMax M2.1 Free, sinirli bir sure icin aboocode'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Big Pickle, sinirli bir sure icin aboocode'da ucretsiz olan gizli bir modeldir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
...
Aboocode Zen'i su amaclarla olusturduk:
...
4. Herhangi bir kodlama ajaniyla kullanima izin vererek **kilitlenmeyi onlemek** ve aboocode'da diger provider'lari her zaman acik tutmak
