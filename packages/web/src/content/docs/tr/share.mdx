---
title: Paylasim
description: aboocode konusmalarini genel baglantilarla paylasin.
---

aboocode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda aboocode:
...
aboocode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak aboocode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `aboocode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda aboocode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
