---
title: Özel Araçlar
description: LLM'un aboocode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. aboocode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.aboocode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/aboocode/tools/` içine yerleştirerek.
