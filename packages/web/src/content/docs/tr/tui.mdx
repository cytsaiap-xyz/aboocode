---
title: TUI
description: aboocode terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

aboocode, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

aboocode'u calistirdiginizda mevcut dizin icin TUI baslar.
...
aboocode TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
aboocode'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
aboocode'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini aboocode config dosyanizdan ozellestirebilirsiniz.
