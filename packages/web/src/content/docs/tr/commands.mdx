...
`.aboocode/commands/test.md` oluştur:
...
aboocode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

aboocode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/aboocode/commands/`
- Proje başına: `.aboocode/commands/`
...
aboocode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
