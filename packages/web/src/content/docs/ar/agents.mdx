...
يوجد نوعان من الوكلاء في Aboocode: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Aboocode مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Aboocode مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Aboocode مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `aboocode.json`:
...
- عام: `~/.config/aboocode/agents/`
- لكل مشروع: `.aboocode/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Aboocode القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Aboocode العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Aboocode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Aboocode Zen](/docs/zen)، فستستخدم `aboocode/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `aboocode models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/cytsaiap-xyz/aboocode).
:::
