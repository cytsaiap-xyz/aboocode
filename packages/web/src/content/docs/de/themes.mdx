...
Mit Aboocode kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Aboocode das `aboocode`-Theme.
...
Aboocode liefert mehrere eingebaute Themes mit.
...
- Aboocode optisch ans Terminal anpassen wollen
...
Aboocode unterstuetzt ein flexibles JSON-basiertes Theme-System.
