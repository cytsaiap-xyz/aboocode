---
title: TUI
description: Arbeite mit Aboocode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Aboocode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Aboocode die TUI im aktuellen Verzeichnis.
...
In der Aboocode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Add a provider to Aboocode. Allows you to select from available providers and add their API keys.
...
Exit Aboocode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your Aboocode config file.
