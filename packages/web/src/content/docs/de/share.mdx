---
title: Teilen
description: Teile Aboocode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Aboocode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Aboocode Folgendes:
...
Aboocode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Aboocode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`aboocode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du aboocode in deiner Organisation einsetzt.
