---
title: SDK
description: Typsicherer JS-Client fuer den aboocode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das aboocode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und aboocode programmatisch steuern.
...
Erstelle eine aboocode-Instanz:
...
`aboocode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn aboocode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
