...
Erstellen Sie `.aboocode/commands/test.md`:

```md title=".aboocode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Aboocode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Aboocode [config](/docs/config):

```json title="aboocode.jsonc" {4-12}
{
...
- Global: `~/.config/aboocode/commands/`
- Pro Projekt: `.aboocode/commands/`

```markdown title="~/.config/aboocode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".aboocode/commands/component.md"
---
...
```md title=".aboocode/commands/create-file.md"
---
...
```md title=".aboocode/commands/analyze-coverage.md"
---
...
```md title=".aboocode/commands/review-changes.md"
---
...
```md title=".aboocode/commands/review-component.md"
---
...
Aboocode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
