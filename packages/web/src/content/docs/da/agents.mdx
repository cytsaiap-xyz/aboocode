...
Der er to typer agenter i Aboocode; primære agenter og subagenter.
...
Aboocode leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Aboocode leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

Aboocode leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `aboocode.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger Aboocode modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Aboocode-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Aboocode-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Aboocode Zen](/docs/zen), vil du bruge `aboocode/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `aboocode models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/cytsaiap-xyz/aboocode).
:::
