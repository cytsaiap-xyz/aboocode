...
Brug den til at bygge integrasjoner og kontrollere aboocode programmatisk.
...
Opret en forekomst av aboocode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `aboocode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av aboocode, kan du oprete en klientforekomst for at koble til den:
