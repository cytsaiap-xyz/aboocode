---
title: Zen
description: Udvalgt liste over modeller leveret af Aboocode.
---
...
Aboocode Zen er en liste over testede og verificerede modeller leveret af Aboocode-teamet.

:::note
Aboocode Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i Aboocode. Du logger på Aboocode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med Aboocode.
:::
...
Aboocode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Aboocode Zen fungerer som alle andre udbydere i Aboocode.

1. Du logger på **<a href={console}>Aboocode Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger Aboocode Zen og indsætter API-nøglen.
...
[model-id](/docs/config/#models) i Aboocode-konfigurationen
bruger formatet `aboocode/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `aboocode/gpt-5.2-codex` i din konfiguration.
...
- GLM 4.7 Gratis er tilgængelig på Aboocode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Kimi K2.5 Gratis er tilgængelig på Aboocode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- MiniMax M2.1 Gratis er tilgængelig på Aboocode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på Aboocode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede Aboocode Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med Aboocode også.
