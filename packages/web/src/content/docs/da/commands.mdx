...
Opret `.aboocode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Aboocode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Aboocode [config](/docs/config):
...
- Globalt: `~/.config/aboocode/commands/`
- Pr. projekt: `.aboocode/commands/`
...
aboocode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
