...
Crea `.aboocode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Aboocode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Aboocode:
...
- Globale: `~/.config/aboocode/commands/`
- Per progetto: `.aboocode/commands/`
...
aboocode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
