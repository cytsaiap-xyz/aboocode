---
title: TUI
description: Bruke aboocode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

aboocode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre aboocode starter TUI for gjeldende katalog.
...
Når du bruker aboocode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til aboocode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt aboocode. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom aboocode-konfigurasjonsfilen.
