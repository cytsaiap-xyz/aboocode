...
Opprett `.aboocode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Aboocode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Aboocode [config](/docs/config):
...
- Per prosjekt: `.aboocode/commands/`
...
Aboocode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
