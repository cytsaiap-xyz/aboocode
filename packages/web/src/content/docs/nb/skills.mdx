...
Agentferdigheter lar Aboocode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går aboocode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
aboocode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `aboocode.json`:
