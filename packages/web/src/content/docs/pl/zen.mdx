---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez aboocode.
---
...
Aboocode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół aboocode.

:::note
Aboocode Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca aboocode. Logujesz się do Aboocode Zen i dostajesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z aboocode.
:::
...
Aboocode Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

Aboocode Zen działa jak każdy inny dostawca aboocode.

1. Logujesz się do **<a href={console}>Aboocode Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Aboocode Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji aboocode
używa formatu `aboocode/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `aboocode/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie aboocode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na aboocode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie aboocode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w aboocode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z aboocode dowolnego innego dostawcy.
