---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala aboocode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

aboocode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie aboocode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI aboocode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do aboocode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij aboocode. _Aliasy_: `/quit`, `/q`
...
Możesz dostosować zachowanie TUI za pomocą pliku konfiguracyjnego aboocode.
