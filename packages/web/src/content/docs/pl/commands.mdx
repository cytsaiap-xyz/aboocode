...
Utwórz `.aboocode/commands/test.md`:
...
Możesz zdefiniować polecenia w `aboocode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji aboocode:
...
- Globalnie: `~/.config/aboocode/commands/`
- Na projekt: `.aboocode/commands/`
...
aboocode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
