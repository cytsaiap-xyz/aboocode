...
Kreiraj `.aboocode/commands/test.md`:
...
Možete dodati prilagođene komande kroz Aboocode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Aboocode [config](/docs/config):
...
- Globalno: `~/.config/aboocode/commands/`
- Po projektu: `.aboocode/commands/`
...
Aboocode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
