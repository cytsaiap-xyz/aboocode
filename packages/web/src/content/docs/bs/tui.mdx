---
title: TUI
description: Korištenje korisničkog interfejsa Aboocode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Aboocode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Aboocode pokreće TUI za trenutni direktorij.
...
Kada koristite Aboocode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Aboocode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Aboocode. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg Aboocode konfiguracionog fajla.
