---
title: Zen
description: Kurirana lista modela koje nudi Aboocode.
---
...
Aboocode Zen je lista testiranih i provjerenih modela koje obezbjeduje Aboocode tim.

:::note
Aboocode Zen je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u Aboocode. Prijavite se u Aboocode Zen i uzmete API kljuc. Ovo je **potpuno opcionalno** i ne morate ga koristiti da biste koristili Aboocode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s Aboocode.
:::
...
Aboocode Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

Aboocode Zen radi kao i svaki drugi provajder u Aboocode.

1. Prijavite se na **<a href={console}>Aboocode Zen</a>**, dodajte billing podatke i kopirajte API kljuc.
2. U TUI-ju pokrenite `/connect`, izaberite Aboocode Zen i zalijepite API kljuc.
...
[model id](/docs/config/#models) u Aboocode konfiguraciji koristi format `aboocode/<model-id>`. Na primjer, za GPT 5.2 Codex u konfiguraciji koristite `aboocode/gpt-5.2-codex`.
...
- GLM 4.7 Free je dostupan na Aboocode ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
- Kimi K2.5 Free je dostupan na Aboocode ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
- MiniMax M2.1 Free je dostupan na Aboocode ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
- Big Pickle je stealth model koji je besplatan na Aboocode ograniceno vrijeme. Tim koristi taj period za prikupljanje feedbacka i unapredenje modela.
...
4. Obezbijedimo **bez lock-ina** tako da Zen mozete koristiti sa bilo kojim coding agentom, uz slobodu koristenja drugih provajdera u Aboocode.
