...
Crear `.aboocode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Aboocode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Aboocode [config](/docs/config):
...
- Por proyecto: `.aboocode/commands/`
...
aboocode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
