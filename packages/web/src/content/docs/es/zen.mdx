---
title: Zen
description: Lista seleccionada de modelos proporcionada por Aboocode.
---
...
Aboocode Zen es una lista de modelos probados y verificados proporcionada por el equipo Aboocode.

:::note
Aboocode Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en Aboocode. Inicias sesion en Aboocode Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar Aboocode.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Aboocode.
:::
...
Aboocode Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

Aboocode Zen funciona como cualquier otro proveedor en Aboocode.

1. Inicias sesión en **<a href={console}>Aboocode Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona Aboocode Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de Aboocode
usa el formato `aboocode/<model-id>`. Por ejemplo, para GPT 5.2 Codex, debes
usar `aboocode/gpt-5.2-codex` en tu configuracion.
...
- GLM 4.7 Free está disponible en Aboocode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Kimi K2.5 Free está disponible en Aboocode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- MiniMax M2.1 Free está disponible en Aboocode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en Aboocode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con Aboocode también.
