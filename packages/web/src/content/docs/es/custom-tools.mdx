...
description: Cree herramientas que LLM pueda llamar en aboocode.
---

Las herramientas personalizadas son funciones que usted crea y que el LLM puede llamar durante las conversaciones. Trabajan junto con las [herramientas integradas](/docs/tools) de aboocode como `read`, `write` y `bash`.
...
- Localmente colocándolos en el directorio `.aboocode/tools/` de tu proyecto.
- O de forma global, colocándolos en `~/.config/aboocode/tools/`.
