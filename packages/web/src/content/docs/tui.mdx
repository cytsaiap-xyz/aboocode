---
title: TUI
description: Using the Aboocode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Aboocode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Aboocode starts the TUI for the current directory.
...
When using the Aboocode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
