...
import { Tag } from "@aboocode/ui/tag"
import { showToast } from "@aboocode/ui/toast"
import { iconNames, type IconName } from "@aboocode/ui/icons/provider"
...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "aboocode", key: "dialog.provider.aboocode.note" },
...
export const SettingsProviders: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "aboocode" || Object.values(p.models).find((m) => m.cost?.input))
  })
