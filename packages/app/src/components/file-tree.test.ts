...
beforeAll(async () => {
  ...
  mock.module("@aboocode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@aboocode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@aboocode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@aboocode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
