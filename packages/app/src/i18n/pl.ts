export const dict = {
  ...
  "dialog.provider.aboocode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Aboocode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Aboocode.",
  ...
  "provider.connect.aboocodeZen.line1":
    "Aboocode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.aboocodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.aboocodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.aboocodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Aboocode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Aboocode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w aboocode.json",
  ...
  "dialog.server.description": "Przełącz serwer Aboocode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Aboocode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Aboocode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (aboocode.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Aboocode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Aboocode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the Aboocode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Aboocode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Aboocode na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Aboocode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Aboocode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Aboocode.",
