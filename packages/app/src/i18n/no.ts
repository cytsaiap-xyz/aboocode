...
export const dict = {
  ...
  "dialog.provider.aboocode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Aboocode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Aboocode.",
  ...
  "provider.connect.aboocodeZen.line1":
    "Aboocode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.aboocodeZen.visit.prefix": "Besøk ",
  "provider.connect.aboocodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.aboocodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Aboocode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Aboocode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i aboocode.json",
  ...
  "dialog.server.description": "Bytt hvilken Aboocode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Aboocode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Aboocode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (aboocode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Aboocode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Aboocode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Aboocode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Aboocode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Aboocode ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Aboocode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Aboocode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Aboocode.",
