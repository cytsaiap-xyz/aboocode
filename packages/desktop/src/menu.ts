      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            ...
            text: "Aboocode Documentation",
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/aboocode"),
            text: "Support Forum",
          }),
          await PredefinedMenuItem.new({
            item: "Separator",
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/cytsaiap-xyz/aboocode/issues/new?template=feature_request.yml"),
            text: "Share Feedback",
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/cytsaiap-xyz/aboocode/issues/new?template=bug_report.yml"),
            text: "Report a Bug",
          }),
        ],
      }),
