...
import desktopAppIcon from "../../asset/lander/aboocode-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g aboocode-ai")}>
                <code>
                  npm i -g <strong>aboocode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g aboocode-ai")}>
                <code>
                  bun add -g <strong>aboocode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install cytsaiap-xyz/tap/aboocode")}>
                <code>
                  brew install <strong>cytsaiap-xyz/tap/aboocode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S aboocode")}>
                <code>
                  paru -S <strong>aboocode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask aboocode-desktop")}>
                <code>
                  brew install --cask <strong>aboocode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
