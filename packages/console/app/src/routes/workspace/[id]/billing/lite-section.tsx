...
import { Database, eq, and, isNull } from "@aboocode/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@aboocode/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#aboocode-go")} target="_blank" rel="noopener noreferrer">
