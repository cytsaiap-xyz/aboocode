...
import compareVideo from "../../asset/lander/aboocode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/aboocode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="aboocode:auth" content={loggedin() ? "true" : "false"} />
