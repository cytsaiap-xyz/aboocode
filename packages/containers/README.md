...
```
REGISTRY=ghcr.io/cytsaiap-xyz TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/cytsaiap-xyz TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/cytsaiap-xyz/build/bun-node:24.04
```
