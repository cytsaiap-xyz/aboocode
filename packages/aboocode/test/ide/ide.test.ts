...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ABOOCODE_CALLER", () => {
    process.env["ABOOCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ABOOCODE_CALLER", () => {
    process.env["ABOOCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ABOOCODE_CALLER", () => {
    process.env["ABOOCODE_CALLER"] = "unknown"
