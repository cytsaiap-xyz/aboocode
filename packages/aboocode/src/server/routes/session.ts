  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all AbooCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific AbooCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new AbooCode session for interacting with AI assistants and managing conversations.",
