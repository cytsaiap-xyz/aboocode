/**
 * Team + private combined memory prompt builder.
 * Ported from claude-code-leak/src/memdir/teamMemPrompts.ts.
 */
...
export async function buildCombinedMemoryPrompt(extraGuidelines?: string[], skipIndex = false): Promise<string> {
