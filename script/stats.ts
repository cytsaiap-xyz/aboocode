...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/cytsaiap-xyz/aboocode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for cytsaiap-xyz/aboocode...\n")
...
console.log("Fetching npm all-time downloads for aboocode...\n")
const npmDownloads = await fetchNpmDownloads("aboocode")
